...
class Raycast
{
	public:
		 ...
		 */
		bool Hit(const DirectX::SimpleMath::Vector3& start, const DirectX::SimpleMath::Vector3& direction, const float distance, ColliderComponent& collider, const bool& returnFirstHit = true);
