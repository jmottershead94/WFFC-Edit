...
class Observer
{
	public:
		 ...
		 */
		virtual void OnNotify(EventType& currentEvent) = 0;
		 ...
		 */
		virtual void OnNotify(EventType& currentEvent, const DirectX::SimpleMath::Vector3& cursorPosition, const DirectX::SimpleMath::Vector3& cameraLookDirection) = 0;
};